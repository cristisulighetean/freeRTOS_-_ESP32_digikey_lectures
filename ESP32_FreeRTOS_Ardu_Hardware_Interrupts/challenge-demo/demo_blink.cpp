...
static volatile int isr_counter;    // value can change inside an ISR
// Only use for critical sections
...
// We are using IRAM_ATTR to acces it faster
// As we store it in RAM
